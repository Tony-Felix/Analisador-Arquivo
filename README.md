...
- Use o comando: `git clone git@github.com:tryber/python-035-python-projeto-pro-filer.git`
- Entre na pasta do repositório que você acabou de clonar:
  - `cd python-035-python-projeto-pro-filer`
...
- Verifique que você está na raiz do projeto:
  - Exemplo: `pwd` -> o retorno vai ser algo tipo _/Users/maria/code/**python-035-python-projeto-pro-filer**_
...
[Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH35-PYTHON&template=betrybe/python-0x-projeto-pro-filer)
